      ...
      expressiveCode: {
        ...
        styleOverrides: {
          ...
          frames: {
            ...
            editorTabBarBackground: '#1a1d24',
            editorActiveTabBackground: '#161922',
            editorActiveTabForeground: '#e5e9f0',
            editorActiveTabBorderColor: '#1f232c',
            editorActiveTabIndicatorTopColor: 'transparent',
            editorActiveTabIndicatorBottomColor: '#3b82f6',
            editorActiveTabIndicatorHeight: '2px',
            editorTabBarBorderBottomColor: '#1f232c',
            editorTabBorderRadius: '6px',
            terminalBackground: '#161922',
            terminalTitlebarBackground: '#1a1d24',
            terminalTitlebarForeground: '#e5e9f0',
            terminalTitlebarBorderBottomColor: '#1f232c',
